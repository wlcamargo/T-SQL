...
INSERT INTO TB_NASCIMENTO_CLIENTES VALUES ('07/11/1988')
INSERT INTO TB_NASCIMENTO_CLIENTES VALUES ('07/11/1988')
INSERT INTO TB_NASCIMENTO_CLIENTES VALUES ('07/11/1988')
INSERT INTO TB_NASCIMENTO_CLIENTES VALUES ('07/11/1988')
INSERT INTO TB_NASCIMENTO_CLIENTES VALUES ('07/11/1988')
...
TC.[SEXO_CLIENTE],
TNC.DATA_NASCIMENTO
  FROM [STG].[dbo].[TB_CLIENTES] TC
  INNER JOIN TB_NASCIMENTO_CLIENTES TNC
	ON TC.ID_CLIENTE = TNC.ID_CLIENTE 
...
TNC.DATA_NASCIMENTO
  FROM [STG].[dbo].[TB_CLIENTES] TC
  LEFT JOIN TB_NASCIMENTO_CLIENTES TNC
  	ON TC.ID_CLIENTE = TNC.ID_CLIENTE